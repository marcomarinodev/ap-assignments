    ...
    private void initComponents() {
        ...
        listener = new VetoableChangeListener() {
            ...
            public void vetoableChange(PropertyChangeEvent evt) throws PropertyVetoException {
                ...
                try {
                    Double doubledValue = Double.parseDouble(newValue);

                    if (doubledValue < 0) {
                        throw new PropertyVetoException("NotPositive", evt);
                    }
                } catch (NumberFormatException nfe) {
                    throw new PropertyVetoException("Nan", evt);
                }
            }
        };

        tempLabel.addVetoableChangeListener(listener);

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        tempLabel.setText("abc");
